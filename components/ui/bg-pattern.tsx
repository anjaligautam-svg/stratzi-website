...
// Mask gradients use opaque-vs-transparent stops. The original component
// referenced `var(--background)` which only matters for the alpha channel
// of CSS masks — `black` works universally and avoids depending on a
// CSS variable that may not exist in the host project.
